...
public class CrearRestaurant extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar();
        NombreRes = findViewById(R.id.restaurName);
        NitRes = findViewById(R.id.restaurNit);
        PropietarioRes = findViewById(R.id.restaurPropietario);
        CalleRes = findViewById(R.id.restaurCalle);
        TelefonoRes = findViewById(R.id.restaurTelefono);
        RegistroRestaurant = findViewById(R.id.restaurRegistro);
    ...
    public void senResgistrar(){
        ...
        client.post(EndPoinds.REST+"/restaurant", req, new JsonHttpResponseHandler(){
            @Override
